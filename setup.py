...
DESCRIPTION = metadata.get('description', 'classify products, products on demand and reoder strategies')
AUTHOR = metadata.get('author', 'Predictum')
AUTHOR_EMAIL = metadata.get('author_email', 'alexis.schiavon@gmail.com')
